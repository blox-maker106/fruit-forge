  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        ...
        style: {
          background: "linear-gradient(180deg, oklch(0.18 0.03 270) 0%, oklch(0.14 0.02 260) 100%)",
          borderBottom: "2px solid oklch(var(--primary) / 0.4)"
        },
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 h-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 flex items-center", children: isResultPage ? /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/draw", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "ghost",
              size: "icon",
            ...
            "div",
            {
              ...
              style: {
                ...
                boxShadow: "0 0 12px oklch(var(--primary) / 0.5), 0 2px 8px rgba(0,0,0,0.3)"
              },
              children: "🍑"
            }
          ) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex flex-col", "data-ocid": "main-content", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
        className: "border-t border-border py-3 px-4 text-center",
        style: {
          background: "linear-gradient(180deg, oklch(0.14 0.02 260) 0%, oklch(0.11 0.015 260) 100%)",
...
function AppProvider({ children }) {
  const [drawingDataURL, setDrawingDataURL] = reactExports.useState(
    null
  );
  const [currentGeneration, setCurrentGeneration] = reactExports.useState(
    null
  );
  const [designPrompt, setDesignPrompt] = reactExports.useState("");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    AppContext.Provider,
    {
      value: {
...
const DrawPage = reactExports.lazy(() => __vitePreload(() => import("./DrawPage-CbvQYNUI.js"), true ? [] : void 0));
const ResultPage = reactExports.lazy(() => __vitePreload(() => import("./ResultPage-BzH8hV0w.js"), true ? [] : void 0));
const PageFallback = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-4 p-4", children: [
...
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) }) })
});
const indexRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/draw" })
});
