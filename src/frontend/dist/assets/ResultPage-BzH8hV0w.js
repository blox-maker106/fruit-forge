import { c as createLucideIcon, j as jsxRuntimeExports, S as Slot, b as cn, f as cva, r as reactExports, o, v as vt, e as useNavigate, d as useAppContext, B as Button, g as Skeleton } from "./index-Cwsn1Ar_.js";
/**
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(circle, oklch(var(--secondary) / 0.25) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              background: "linear-gradient(oklch(0.12 0.02 260), oklch(0.12 0.02 260)) padding-box, linear-gradient(135deg, oklch(var(--primary)), oklch(var(--secondary)), oklch(var(--accent)), oklch(var(--primary))) border-box",
              borderRadius: "50%"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              width: cfg.inner,
              height: cfg.inner,
              background: "radial-gradient(ellipse at 35% 30%, oklch(0.22 0.03 280), oklch(0.12 0.02 260))",
              boxShadow: "inset 0 -4px 16px rgba(0,0,0,0.4), inset 0 4px 12px rgba(255,255,255,0.08)"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
        ...
        size !== "sm" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              background: "linear-gradient(180deg, oklch(0.55 0.15 130), oklch(0.4 0.1 130))",
...
function ResultSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-40 rounded-full mx-auto" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-64 w-64 rounded-full mx-auto" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-64 rounded-full mx-auto" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-11 w-32 rounded-xl" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-11 w-32 rounded-xl" }),
...
function ResultError({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-full bg-destructive/15 flex items-center justify-center text-5xl", children: "😵" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-xl text-foreground", children: "Uh oh! Something broke!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs font-body", children: message })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
...
function RecentThumbnail({ gen }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(FruitDisplay, { imageUrl: gen.imageUrl, alt: gen.prompt, size: "sm" })
    }
  );
}
function ResultPage() {
  ...
  const isLoading = !currentGeneration || currentGeneration.status.kind === "pending" || currentGeneration.status.kind === "processing";
  const hasFailed = (currentGeneration == null ? void 0 : currentGeneration.status.kind) === "failed";
  const failureMessage = hasFailed ? currentGeneration.status.error : "";
  const isComplete = (currentGeneration == null ? void 0 : currentGeneration.status.kind) === "complete";
  reactExports.useEffect(() => {
    if (!currentGeneration) {
      void navigate({ to: "/draw" });
    }
  }, [currentGeneration, navigate]);
  const recentGens = isComplete && currentGeneration ? [currentGeneration] : [];
  const handleDownload = () => {
    if (!(currentGeneration == null ? void 0 : currentGeneration.imageUrl)) return;
    const a = document.createElement("a");
    a.href = currentGeneration.imageUrl;
    a.download = "blox-fruit-design.png";
    a.click();
    ue.success("Saving your Blox Fruit! ⚡🍑");
  };
  const handleShare = async () => {
    const url = (currentGeneration == null ? void 0 : currentGeneration.imageUrl) ?? window.location.href;
    if (navigator.share) {
      try {
      ...
      ue.success("Link copied! Share it with your crew! 🏴‍☠️");
    }
  };
  const handleTryAgain = () => {
    void navigate({ to: "/draw" });
  };
  if (isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx(ResultSkeleton, {});
  if (hasFailed) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ResultError,
      {
  ...
  if (!currentGeneration) return /* @__PURE__ */ jsxRuntimeExports.jsx(ResultSkeleton, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-0 pb-8", "data-ocid": "result-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        className: "flex flex-col items-center gap-4 px-4 pt-6 pb-10",
        style: {
          background: "radial-gradient(ellipse at 50% 60%, oklch(var(--secondary) / 0.18) 0%, transparent 65%), linear-gradient(180deg, oklch(0.14 0.03 280) 0%, oklch(0.1 0.015 260) 100%)"
        },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  ...
                  children: "⚡ Your Blox Fruit design is ready!"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", "data-ocid": "fruit-display-container", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "absolute -inset-10 rounded-full pointer-events-none",
                    style: {
                      background: "radial-gradient(circle, oklch(var(--secondary) / 0.2) 0%, transparent 70%)",
                      filter: "blur(20px)"
                    }
                  }
                ),
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        children: "LEGENDARY FRUIT UNLOCKED!"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: "🔥" })
                  ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-4 -mt-4 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "generation-prompt", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: "text-xs font-display font-bold mb-1 uppercase tracking-widest",
                      style: { color: "oklch(var(--accent))" },
                      children: "⚡ Fruit Power"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-foreground leading-relaxed", children: currentGeneration.prompt || "A mysterious devil fruit with unknown powers…" })
                ] }),
                drawingDataURL && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-display font-bold text-foreground", children: "✏️ Your sketch" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: "The drawing that started it all!" })
                      ] })
                    ]
                  }
                )
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Recent Fruits"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 overflow-x-auto pb-1", children: recentGens.map((gen) => /* @__PURE__ */ jsxRuntimeExports.jsx(RecentThumbnail, { gen }, gen.id)) })
          ]
        }
      )
    ] })
